...
public class HoleESP
    ...
    private Setting<Integer> bRockBlue = this.register(Settings.integerBuilder("BRock Blue").withMinimum(0).withMaximum(255).withValue(255).build());
    private Setting<Integer> alpha = this.register(Settings.integerBuilder("Alpha").withMinimum(0).withMaximum(255).withValue(125).build());
    ...
    private Setting<Float> width = this.register(Settings.floatBuilder("Line Width").withMinimum(Float.valueOf(0.0f)).withMaximum(Float.valueOf(7.0f)).withValue(Float.valueOf(1.5f)).build());

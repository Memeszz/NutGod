...
//
//    private Setting<Double> range = register(Settings.doubleBuilder("Range").withMinimum(0.0).withMaximum(16.0).withValue(8.0).build());
//
//    @Override
...
//            .forEach(e -> {
//                if (mc.player.getDistance(e.posX, e.posY, e.posZ) <= range.getValue().floatValue()) {
